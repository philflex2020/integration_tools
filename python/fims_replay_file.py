                ...
                if methd and uri:
                    if methd == "pub" or methd == "set" or methd == "get":
                        ...
                        if text.lower() == "y" or text.lower() == "yes":
                            output_fims_msg(methd, uri, reply_to, body)
                methd, uri, reply_to, body = "", "", "", ""
...
def output_fims_msg(methd, uri, reply_to, body):
    uri = "/flex"+uri
    if not body and not reply_to:
        print("/usr/local/bin/fims/fims_send -m " + methd +" -u "+uri)
    elif body and not reply_to:
        print("/usr/local/bin/fims/fims_send -m " + methd +" -u "+uri+" '"+body+"'")
    elif not body and reply_to:
        print("/usr/local/bin/fims/fims_send -m " + methd +" -u "+uri+" -r "+reply_to)
    else:
        print("/usr/local/bin/fims/fims_send -m " + methd +" -u "+uri+" -r "+reply_to+" '"+body+"'")
